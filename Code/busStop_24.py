#117 Street & Jasper Avenue,Stop#:1960
...
Train = r'./Data/BustStop/bustStop_24.csv'
Target = r'./Data/ExtraData/extraData_24.csv'
divPath = r'./Data/MAPE/MAPE_24.csv'
...
## small example.
X = df[1:1600].values
y = diff[1:1600]['diff'].values
#print(X)
#print(y)
Xtest = df[1700:1800].values;
yTarget = diff[1700:1800]['diff'].values;

meanDiv = div[1700:1800].values
